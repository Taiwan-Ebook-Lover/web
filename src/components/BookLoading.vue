...
<style lang='scss' scoped>
  ...
  .book-item {
    ...
    border: $thickness solid $bookColor;
    ...
    &.fifth {
      ...
      &:after {
        ...
        border-top: $thickness solid $bookColor;
        border-bottom: $thickness solid $bookColor;
      }
  ...
  .shelf {
    ...
    &:after {
      ...
      width: 100%;
      height: 100%;
      @include polka(10px, 30%, $bookColor, rgba(255,255,255,0.5));
      top: 200%;
      left: 5%;
